...
| N26 | `packages/geoscratch/src/scratch/pass.ts:669` | current surface-texture `GPUTexture.createView()` | Render descriptor lowering runs inside the submission `pass-begin` issue. | Observed submission pass begin |
