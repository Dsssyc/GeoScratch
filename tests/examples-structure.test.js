...
describe('examples structure', () => {
    ...
    it('lets the DEM layer example start without a committed Mapbox token', () => {
        ...
        expect(source).to.include('this.transform.mercatorMatrix')
        expect(source).to.include('this.transform.farZ')
        expect(source).to.include('this.transform.nearZ')
        ...
        expect(source).to.not.include('this.transform.clone()')
