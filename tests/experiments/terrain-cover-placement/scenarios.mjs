export async function scenarios(options) {
    ...
    const independent = { sameAState: JSON.stringify([beforeA.state.coverPatchCount, beforeA.state.coverLevelRange, (beforeA.state.coverSelection ?? beforeA.state.coverFeedback)?.minimumCellSpanReferencePixels, (beforeA.state.coverSelection ?? beforeA.state.coverFeedback)?.maximumCellSpanReferencePixels]) === JSON.stringify([afterA.state.coverPatchCount, afterA.state.coverLevelRange, (afterA.state.coverSelection ?? afterA.state.coverFeedback)?.minimumCellSpanReferencePixels, (afterA.state.coverSelection ?? afterA.state.coverFeedback)?.maximumCellSpanReferencePixels]), sameADemands: JSON.stringify(beforeA.selectedKeys) === JSON.stringify(afterA.selectedKeys) }
