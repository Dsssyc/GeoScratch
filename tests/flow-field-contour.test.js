...
describe('Flow Field contour reference', () => {
    ...
    it('injects borrowed temporal and draw-view bindings without owning them', () => {
        ...
        expect(source).to.include('bindLayouts: [ computeLayout, temporal.bindLayout ]')
        ...
        expect(source).to.not.include('temporal.bindSet.dispose()')
        expect(source).to.not.include('temporal.bindLayout.dispose()')
