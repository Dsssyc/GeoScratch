...
describe('scratch GPU operation provenance documentation', () => {
    ...
    it('inventories every current native buffer and texture creation call site', () => {
        ...
        expect(callSites).to.have.length(9)
        expect(inventoryRows).to.have.length(9)
        ...
        expect(inventoryRows.filter(row => row.includes('Raw native escape hatch'))).to.have.length(5)
