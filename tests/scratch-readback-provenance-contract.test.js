...
describe('scratch readback provenance contract', () => {
    ...
    it('uses schema version 5 command and readback targets without resource placeholders', () => {
        ...
        expect(commandRecord.version).to.equal(5)
        ...
        expect(readbackRecord.version).to.equal(5)
